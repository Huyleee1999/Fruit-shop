...
<html lang="en">
    ...
    <div class="container-fluid page-header py-5" style="background-image: url('{{ asset('picture/accounts/cart-page-header-img.jpg') }}'); background-size: cover; background-position: center;">
        <div class="text-center">
            <h1 class="text-white display-6">Checkout</h1>
        </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-5">
                        ...
                        <div class="row g-4 text-center align-items-center justify-content-center pt-4">
                            <button name="btn-proceed" value="{{ $data[0]->cart_id }}" type="submit" class="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary">Place Order</button>
                        </div>
                    </div>
                </div>
            </form>
