...
@section('main')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Add Fruit</h4>
                @if ($errors->any())
                ...
                @endif
                <form class="forms-sample" method="POST" action="{{ route('fruit.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" id="name" placeholder="Type something..."
                            name="name" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="profile_picture" name="image" accept="image/*" required>
                    </div>

                    <button type="submit" class="btn btn-primary me-2">Create</button>
                    <a href="{{ route('fruit.index') }}" class="btn btn-light">Back</a>
                </form>
            </div>
        </div>
    </div>
